...
basicMathControlled = feols(G3~Dalc+Walc+age+goout+romantic+famrel,MathData)
basicPortugueseControlled = feols(G3~Dalc+Walc+age+goout+romantic+famrel,PortugueseData)
...
factoredMath = feols(G3 ~ factor(Dalc) + factor(Walc) + goout + romantic + age + famrel, data = MathData)
factoredPortuguese = feols(G3 ~ factor(Dalc) + factor(Walc) + goout + romantic + age + famrel, data = PortugueseData)
...
binaryControlledMath = feols(G3 ~ highDalc + highWalc + goout + romantic + age + famrel, data = MathData)
binaryControlledPortuguese = feols(G3 ~ highDalc + highWalc + goout + romantic + age + famrel, data = PortugueseData)
etable(binaryControlledMath,binaryControlledPortuguese)
```

```{r}
#Interacting romantic and sex
sexMath = feols(G3 ~ highDalc + highWalc + goout + romantic*sex + age + famrel, data = MathData)
sexPortuguese = feols(G3 ~ highDalc + highWalc + goout + romantic*sex + age + famrel, data = PortugueseData)
...
quadMath = feols(G3~Dalc+I(Dalc^2)+Walc+I(Walc^2)+age+goout+romantic,MathData)
quadPortuguese = feols(G3~Dalc+I(Dalc^2)+Walc+I(Walc^2)+age+goout+romantic,PortugueseData) 
